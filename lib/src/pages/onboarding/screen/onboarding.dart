...
// final pages = [
//
// OnBoardingWidget(skipTextColor: const Color(0xff555555),subTitleTextColor: const Color(0xff303030).withOpacity(0.8), titleTextColor: const Color(0xff303030), color: const Color(0xffFDFDFD),image: '',skip: 'Skip',title: 'A place to Vent', subTitle: 'Share how you feel with people who can relate.',next: '',),
